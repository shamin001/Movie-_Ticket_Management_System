...
public class Now_showing extends JFrame implements ActionListener{
	
	JPanel panel;
	JLabel back_gro, upper_Line, movie_1, movie_2, movie_3, movie_4, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11;
	...
	public Now_showing(){
		...
		movie1 = new ImageIcon("Image/Showing_1.jpg");
		movie_1 = new JLabel(movie1);
		movie_1.setBounds(60,120,180,300);
		panel.add(movie_1);
		
		movie2 = new ImageIcon("Image/Showing_2.jpg");
		movie_2 = new JLabel(movie2);
		movie_2.setBounds(323,120,180,300);
		panel.add(movie_2);
		
		movie3 = new ImageIcon("Image/Showing_3.jpg");
		movie_3 = new JLabel(movie3);
		movie_3.setBounds(588,120,180,300);
		panel.add(movie_3);
		
		movie4 = new ImageIcon("Image/Showing_4.jpg");
		movie_4 = new JLabel(movie4);
		movie_4.setBounds(860,120,180,300);
		panel.add(movie_4);
		
		//text
		
		a1 = new JLabel("Dune");
		a1.setBounds(125,430,60,30);
		a1.setFont(f4);
		...
		a2 = new JLabel("I want to eat");
		a2.setBounds(350,430,130,30);
		a2.setFont(f4);
		a2.setForeground(Color.WHITE);
		panel.add(a2);
		
		a3 = new JLabel("Your Pancreas");
		a3.setBounds(335,460,155,30);
		a3.setFont(f4);
		a3.setForeground(Color.WHITE);
		panel.add(a3);
		
		a4 = new JLabel("Garden of Words");
		a4.setBounds(590,430,180,30);
		a4.setFont(f4);
		a4.setForeground(Color.WHITE);
		panel.add(a4);
		
		a5 = new JLabel("Avatar");
		a5.setBounds(920,430,100,30);
		a5.setFont(f4);
		...
		a8 = new JLabel("Drama, Romance");
		a8.setBounds(340,500,180,30);
		a8.setFont(f5);
		a8.setForeground(Color.WHITE);
		panel.add(a8);
		
		a9 = new JLabel("Drama, Romance");
		a9.setBounds(600,475,180,30);
		a9.setFont(f5);
		a9.setForeground(Color.WHITE);
		panel.add(a9);
		
		a10 = new JLabel("Action, Fantasy");
		a10.setBounds(890,475,180,30);
		a10.setFont(f5);
		a10.setForeground(Color.WHITE);
		panel.add(a10);
		
		a7 = new JLabel("Adventure");
		a7.setBounds(910,500,180,30);
		a7.setFont(f5);
		a7.setForeground(Color.WHITE);
		panel.add(a7);
